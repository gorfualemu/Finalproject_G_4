<%@ Page Title="" Language="C#" MasterPageFile="~/UI/maine.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Finalproject_G_4.UI.homepage.Contact" %>
    ...
    <div class="largehome">
        ...
        <div class="right_maine_home">
              <p>
                ...
                phone  +25111645238<br />
                Email   DCTA12@gmail.com
            </p>
        </div>
        <div class="left_side">
